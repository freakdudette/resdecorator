...
class ResourceLayoutInflater extends LayoutInflater implements ResourceActivityFactory {
    ...
    public LayoutInflater cloneInContext(Context newContext) {
        return new ResourceLayoutInflater(this, newContext, true);
    }
    ...
    private static class WrapperFactory implements Factory {
        ...
        private final ResourceLayoutInflater mInflater;
        private final ResourceDecoratorFactory mDecorFactory;

        WrapperFactory(Factory factory, ResourceLayoutInflater inflater, ResourceDecoratorFactory decorFactory) {
    ...
    private static class WrapperFactory2 implements Factory2 {
        ...
        final ResourceDecoratorFactory mDecorFactory;

        WrapperFactory2(Factory2 mFactory2, ResourceDecoratorFactory mDecorFactory) {
    ...
    private static class PrivateWrapperFactory2 extends WrapperFactory2 {
        ...
        PrivateWrapperFactory2(Factory2 factory2,
                               ResourceLayoutInflater inflater,
                               ResourceDecoratorFactory decorFactory) {
